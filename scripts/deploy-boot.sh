...
run(){
    ssh $1 "docker run -e \"SPRING_PROFILES_ACTIVE=$2\" -e \"ENCRYPT_KEY=\$ENCRYPT_KEY\" --net=\"host\" --name=$2-$3 -d -p $4:$4 -v /soft/newrelic:/newrelic -v /home/$2/.ssh:/root/.ssh -v /home/$2/$3/log:/log $2/$3";
}
